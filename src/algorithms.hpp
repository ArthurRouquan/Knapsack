...
sorted. Doesn't build the entire table, only work with one column. */
...
/* Solves the instance with a primal Branch & Bound, Best First Search. Items are expected
to be sorted by increasing efficiency. */
